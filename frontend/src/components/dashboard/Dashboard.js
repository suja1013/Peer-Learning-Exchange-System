          ...
          {[
            {
              ...
              icon: '📚',
              title: 'My Skills',
              desc: 'Manage skills you teach & want to learn',
              color: '#ebf4ff'
            },
            {
              to: '/search',
              icon: '🔍',
              title: 'Find Tutors',
              desc: 'Search for tutors by skill',
              color: '#f0fff4'
            },
            {
              to: '/recommendations',
              icon: '🤖',
              title: 'AI Tutor Recommendations',
              desc: 'Get smart AI-inspired tutor recommendations based on skill match, ratings, and experience',
              color: '#eef2ff'
            },
            {
              to: '/requests',
              ...
              desc: 'Manage your incoming & outgoing requests',
              color: '#fffaf0'
            },
            {
              to: '/meetings',
              icon: '🎯',
              title: 'My Meetings',
              desc: 'View your scheduled sessions',
              color: '#faf5ff'
            },
